...
class ActividadRegistracion : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val bolsa = Bundle();
        bolsa.putString("Bienvenido", "Se abrio la app");
        pruebaAnalytics.logEvent("IniciarApp", bolsa);
    ...
    private val registracionCompletaListener: OnCompleteListener<AuthResult?> = OnCompleteListener { task ->
        if (task.isSuccessful) {
            ...
            //agrege el "verPartidas()" para cuando se registra el usuario con exito, lo envie a ver partidas
            verPartidas()
